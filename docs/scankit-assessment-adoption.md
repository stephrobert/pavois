...
- `Ruleset` = `{Name:"pavois-baseline", Version:<ruleset_version>, Digest:<content hash>}` —
  version exists; **add a content digest of the evaluated profile** (closes gap: the bundle
