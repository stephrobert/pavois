...
control 'pkg-gnome-software-installed' do
  impact 0.5
  title 'Install GNOME Software'
  tag domain: 'Packages'
  tag evidence: 'inventory-state'
  tag reboot: 'yes'
  tag ssg: 'package_gnome_software_installed'
...
control 'pkg-screen-installed' do
  impact 0.5
  ...
  tag reboot: 'yes'
  tag nist: '3.1.10'
  tag ssg: 'package_screen_installed'
...
control 'pkg-talk-server-removed' do
  impact 1.0
