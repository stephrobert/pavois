...
control 'ssh-enable-pam' do
  ...
  tag evidence: 'effective-runtime'
  tag reboot: 'yes'
  tag cis: ['2.2.6', '5.1.22']
  tag('pci-dss' => '2.2.6')
  tag stig: 'UBTU-24-500050'
  tag level_cis: '1'
...
control 'ssh-use-approved-ciphers-ordered' do
  ...
  tag evidence: 'effective-runtime'
  tag reboot: 'yes'
  tag stig: 'UBTU-24-100820'
  tag ssg: 'sshd_use_approved_ciphers_ordered_stig'
  describe command('sshd -T') do
    its('stdout') { should match(/^ciphers\s+aes256\-gcm@openssh\.com,aes128\-gcm@openssh\.com,aes256\-ctr,aes128\-ctr$/i) }
  end
end
...
control 'ssh-use-approved-kex-ordered' do
  ...
  tag reboot: 'yes'
  tag nist: 'AC-17(2)'
  tag stig: 'UBTU-24-100840'
  tag ssg: 'sshd_use_approved_kex_ordered_stig'
  describe command('sshd -T') do
    its('stdout') { should match(/^kexalgorithms\s+ecdh\-sha2\-nistp521,ecdh\-sha2\-nistp384,ecdh\-sha2\-nistp256,diffie\-hellman\-group\-exchange\-sha256,diffie\-hellman\-group16\-sha512,diffie\-hellman\-group14\-sha256$/i) }
  end
end
