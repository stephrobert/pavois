...
control 'sysctl-fs-protected_fifos' do
  impact 0.5
  ...
  tag ssg: 'sysctl_fs_protected_fifos'
...
control 'sysctl-fs-protected_regular' do
  impact 0.5
  ...
  tag nist: ['AC-6(1)', 'CM-6(a)']
  tag level_bp28: 'intermediary'
  tag ssg: 'sysctl_fs_protected_regular'
  describe kernel_parameter('fs.protected_regular') do
    its('value') { should cmp 2 }
  end
  describe command("grep -hsE '^[[:space:]]*fs.protected_regular[[:space:]]*=[[:space:]]*2([[:space:]]|$)' /etc/sysctl.conf /etc/sysctl.d/*.conf /run/sysctl.d/*.conf /usr/lib/sysctl.d/*.conf /lib/sysctl.d/*.conf 2>/dev/null") do
    its('stdout') { should match(/\S/) }
  end
end
...
control 'sysctl-kernel-randomize_va_space' do
  ...
  tag reboot: 'yes'
  tag bp28: 'R9'
  tag cis: ['1.5.1', '3.3.1.1']
  tag('pci-dss' => 'Req-2.2.1')
  tag nist: ['3.1.7', 'CM-6(a)', 'SC-30', 'SC-30(2)']
  tag stig: 'UBTU-24-700310'
  tag level_bp28: 'intermediary'
  tag level_cis: '1'
...
control 'sysctl-kernel-unprivileged_bpf_disabled' do
  ...
  tag level_bp28: 'intermediary'
  tag ssg: 'sysctl_kernel_unprivileged_bpf_disabled_accept_default'
...
control 'sysctl-net-ipv4-ip_forward' do
  ...
  tag bp28: 'R12'
  tag cis: ['1.4.3', '3.3.1']
  tag('pci-dss' => ['Req-1.3.1', 'Req-1.3.2'])
  tag nist: ['3.1.20', 'CM-6(a)', 'CM-7(a)', 'CM-7(b)', 'SC-5', 'SC-7(a)']
  tag level_bp28: 'intermediary'
  tag level_cis: '1'
...
control 'sysctl-net-ipv4-tcp_syncookies' do
  ...
  tag reboot: 'yes'
  tag bp28: 'R12'
  tag cis: ['1.4.3', '3.3.10']
  tag('pci-dss' => 'Req-1.4.1')
  tag nist: ['3.1.20', 'CM-6(a)', 'CM-7(a)', 'CM-7(b)', 'SC-5(1)', 'SC-5(2)', 'SC-5(3)(a)']
  tag stig: 'UBTU-24-600190'
  tag level_bp28: 'intermediary'
  tag level_cis: '1'
