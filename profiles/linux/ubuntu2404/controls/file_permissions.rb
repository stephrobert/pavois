...
control 'fileperm-at-deny' do
  ...
  tag cis: '2.4.2.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_at_deny'
...
control 'fileperm-journalctl' do
  impact 0.5
  title 'Verify Permissions on the journal command'
  tag domain: 'File permissions'
  tag evidence: 'persistent-config'
  tag reboot: 'yes'
  tag stig: 'UBTU-24-700030'
  tag ssg: 'file_permissions_journalctl'
...
control 'fileperm-library-dirs' do
  ...
  tag evidence: 'persistent-config'
  tag reboot: 'yes'
  tag nist: ['CM-6(a)', 'CM-5(6)', 'CM-5(6).1', 'AC-6(1)']
  tag stig: 'UBTU-24-300006'
...
control 'fileperm-sshd-drop-in-config' do
  ...
  tag reboot: 'yes'
  tag cis: '5.1.1'
  tag nist: ['AC-17(a)', 'CM-6(a)', 'AC-6(1)']
  tag level_cis: '1'
...
control 'fileperm-sshd-pub-key' do
  ...
  describe command('find /etc/ssh -maxdepth 1 -name "*.pub" -perm /0133 2>/dev/null') do
    its('stdout') { should eq '' }
  end
end
...
control 'fileperm-systemmap' do
  ...
  describe command('find /boot -maxdepth 1 -name "System.map-*" -perm /0177 2>/dev/null') do
    its('stdout') { should eq '' }
  end
end
...
control 'fileperm-unauthorized-world-writable' do
  ...
  tag reboot: 'yes'
  tag bp28: 'R54'
  tag cis: ['2.2.6', '7.1.11']
  tag('pci-dss' => '2.2.6')
  tag nist: ['None', 'AC-6(1)', 'CM-6(a)', 'CM-6(a)', 'AC-6(1)']
...
control 'fileperm-var-log-audit' do
  ...
  tag evidence: 'persistent-config'
  tag reboot: 'yes'
  tag cis: ['10.3.1', '6.2.4.1']
  tag('pci-dss' => 'Req-10.5')
  tag nist: ['3.3.1', 'AC-6(1)', 'AU-9(4)', 'CM-6(a)']
  tag stig: 'UBTU-24-901380'
  tag level_cis: '2'
...
control 'fileperm-var-log-auth' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_auth'
...
control 'fileperm-var-log-cloud-init' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_cloud-init'
...
control 'fileperm-var-log-gdm3' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_gdm3'
...
control 'fileperm-var-log-lastlog' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_lastlog'
...
control 'fileperm-var-log-localmessages' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_localmessages'
...
control 'fileperm-var-log-syslog' do
  impact 0.5
  ...
  tag reboot: 'yes'
  tag cis: '6.1.4.1'
  tag stig: 'UBTU-24-700150'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_syslog'
...
control 'fileperm-var-log-waagent' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_waagent'
...
control 'fileperm-var-log-wbtmp' do
  impact 0.5
  ...
  tag cis: '6.1.4.1'
  tag level_cis: '1'
  tag ssg: 'file_permissions_var_log_wbtmp'
