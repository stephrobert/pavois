...
control 'pkg-nfs-common-removed' do
  impact 0.3
  title 'Uninstall nfs-common Package'
  tag domain: 'Packages'
  tag evidence: 'inventory-state'
  tag reboot: 'yes'
  tag stig: 'UBTU-22-215040'
  tag ssg: 'package_nfs-common_removed'
...
control 'pkg-nss-sss-installed' do
  impact 0.5
  title 'Install nss-sss Package'
  tag domain: 'Packages'
  tag evidence: 'inventory-state'
  tag reboot: 'yes'
  tag stig: 'UBTU-22-254010'
  tag ssg: 'package_nss_sss_installed'
...
control 'pkg-opensc-installed' do
  impact 0.5
  title 'Install the opensc-pkcs11 Package For Multifactor Authentication'
  tag domain: 'Packages'
  tag evidence: 'inventory-state'
  tag reboot: 'yes'
  tag nist: 'CM-6(a)'
  tag stig: 'UBTU-22-612015'
...
control 'pkg-pam-sss-installed' do
  impact 0.5
  ...
  tag reboot: 'yes'
  tag stig: 'UBTU-22-254010'
  tag ssg: 'package_pam_sss_installed'
...
control 'pkg-prelink-removed' do
  impact 0.5
  ...
  tag cis: '1.5.4'
  tag level_cis: '1'
  tag ssg: 'package_prelink_removed'
...
control 'pkg-xserver-xorg-core-removed' do
  ...
  tag level_cis: '2'
  tag ssg: 'package_xorg-x11-server-common_removed'
  describe package('xserver-common') do
    it { should_not be_installed }
  end
end
