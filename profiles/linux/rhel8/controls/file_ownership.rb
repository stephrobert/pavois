...
control 'filegroupowner-efi-grub2-cfg' do
  impact 0.5
  ...
  tag level_cis: '1'
  tag ssg: 'file_groupowner_efi_grub2_cfg'
...
control 'filegroupowner-efi-user-cfg' do
  impact 0.5
  ...
  tag level_bp28: 'enhanced'
  tag level_cis: '1'
  tag ssg: 'file_groupowner_efi_user_cfg'
...
control 'filegroupowner-etc-sysconfig-sshd' do
  impact 0.5
  title 'Verify Group Who Owns /etc/sysconfig/sshd File'
  tag domain: 'File ownership'
  tag evidence: 'filesystem-state'
  tag reboot: 'yes'
  tag cis: '5.1.3'
  tag level_cis: '1'
  tag ssg: 'file_groupowner_etc_sysconfig_sshd'
...
control 'fileowner-efi-grub2-cfg' do
  impact 0.5
  ...
  tag level_bp28: 'enhanced'
  tag level_cis: '1'
  tag ssg: 'file_owner_efi_grub2_cfg'
  only_if { file('/boot/efi/EFI/redhat/grub.cfg').exist? }
  describe file('/boot/efi/EFI/redhat/grub.cfg') do
    its('uid') { should eq 0 }
  end
...
control 'fileowner-efi-user-cfg' do
  impact 0.5
  ...
  tag level_bp28: 'enhanced'
  tag level_cis: '1'
  tag ssg: 'file_owner_efi_user_cfg'
  only_if { file('/boot/efi/EFI/redhat/user.cfg').exist? }
  describe file('/boot/efi/EFI/redhat/user.cfg') do
    its('uid') { should eq 0 }
  end
...
control 'fileowner-etc-sysconfig-sshd' do
  impact 0.5
  title 'Verify User Who Owns /etc/sysconfig/sshd File'
  tag domain: 'File ownership'
  tag evidence: 'filesystem-state'
  tag reboot: 'yes'
  tag cis: '5.1.3'
  tag level_cis: '1'
  tag ssg: 'file_owner_etc_sysconfig_sshd'
  only_if { file('/etc/sysconfig/sshd').exist? }
  describe file('/etc/sysconfig/sshd') do
    its('uid') { should eq 0 }
  end
