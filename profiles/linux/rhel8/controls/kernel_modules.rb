...
control 'kmod-overlayfs-disabled' do
  impact 0.3
  ...
  tag cis: '1.1.1.6'
  tag level_cis: '2'
  tag ssg: 'kernel_module_overlayfs_disabled'
  describe kernel_module('overlayfs') do
    it { should_not be_loaded }
    it { should be_disabled }
  end
end
...
control 'kmod-uvcvideo-disabled' do
  impact 0.5
  title 'Disable the uvcvideo module'
  tag domain: 'Kernel modules'
  tag evidence: 'effective-runtime'
  tag reboot: 'yes'
  tag ssg: 'kernel_module_uvcvideo_disabled'
