...
control 'findloop-no-dirs-unowned-by-root' do
  impact 0.5
  ...
  tag cis: '5.4.2.5'
  tag level_cis: '1'
  tag ssg: 'no_dirs_unowned_by_root'
  describe command('timeout 90 find / -xdev -type d -nouser 2>/dev/null') do
    its('stdout.strip') { should eq '' }
  end
end
