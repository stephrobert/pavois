...
control 'logindefs-pass_max_days' do
  ...
  tag evidence: 'persistent-config'
  tag reboot: 'yes'
  tag cis: ['5.4.1.1', '8.3.9']
  tag('pci-dss' => 'Req-8.2.4')
